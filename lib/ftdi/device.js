...
function FtdiDevice(deviceSettings, connectionSettings, Connection) {
  ...
  if (deviceSettings instanceof ftdi.FtdiDevice) {
    ...
    this.set('deviceSettings', this.ftdiDevice.deviceSettings);
  } else {
    this.set('deviceSettings', deviceSettings);
  }
...
FtdiDevice.prototype.open = function(callback) {
  ...
  if (!this.ftdiDevice) {
    this.ftdiDevice = new ftdi.FtdiDevice(this.get('deviceSettings'));
  }
